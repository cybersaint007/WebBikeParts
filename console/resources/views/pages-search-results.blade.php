                ...
                <div class="card-body p-4">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                            ...
                            <div class="py-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Skote - Admin & Dashboard Template
                                        by Themesbrand</a></h5>
                            ...
                            <div class="py-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Minia - React Js Admin & Dashboard
                                        Template</a></h5>
                            ...
                            <div class="py-3">
                                <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Doson - Angular Admin & Dashboard
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge bg-secondary-subtle text-secondary fs-12">Business</span>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge bg-warning-subtle text-warning fs-12">Development</span>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge bg-info-subtle text-info fs-12">Fashion</span></li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge bg-primary-subtle text-primary fs-12">Product</span></li>
                                                    </ul>
                                        ...
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span
                                                                class="badge bg-danger-subtle text-danger fs-12">Design</span></li>
                                                    </ul>
                            ...
                            <div class="row">
                                <div class="col-lg-12 video-list">
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Create Responsive Admin
                                    ...
                                    <div class="list-element mt-4">
                                        <h5 class="fs-16 mb-1"><a href="javascript:void(0);">Dashboard Admin Basics -
                                                YouTube</a></h5>
                                        <p class="text-success">https://themesbrand.com/velzon/index.html</p>
                                        <div class="d-flex flex-column flex-sm-row">
                                            <div class="flex-shrink-0">
