            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-columns"></i> <span><?php echo app('translator')->get('translation.layouts'); ?></span><span
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-pager"></i> <span><?php echo app('translator')->get('translation.pages'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-pencil-ruler"></i> <span><?php echo app('translator')->get('translation.base-ui'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="widgets">
                        <i class="las la-flask"></i> <span><?php echo app('translator')->get('translation.widgets'); ?></span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="lar la-newspaper"></i> <span><?php echo app('translator')->get('translation.forms'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-table"></i> <span><?php echo app('translator')->get('translation.tables'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCharts" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-chart-pie"></i> <span><?php echo app('translator')->get('translation.charts'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarIcons" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="lab la-fonticons"></i> <span><?php echo app('translator')->get('translation.icons'); ?></span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span
                                       ><?php echo app('translator')->get('translation.feather'); ?></span> <span
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="las la-map"></i> <span><?php echo app('translator')->get('translation.maps'); ?></span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse"
                        ...
                        <i class="las la-folder-plus"></i> <span><?php echo app('translator')->get('translation.multi-level'); ?></span>
                    </a>
...
<?php /**PATH /Users/cybersaint/Sites/WebCrawler/console/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>